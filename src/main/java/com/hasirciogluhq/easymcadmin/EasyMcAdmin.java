...
import com.hasirciogluhq.easymcadmin.listeners.ConsoleListener;
...
public class EasyMcAdmin extends JavaPlugin {
    ...
    public void onDisable() {
        ...
        if (consoleHandler != null) {
            Logger.getLogger("Minecraft").removeHandler(consoleHandler);
        }
    ...
    private void setupConsoleHandler() {
        ...
        try {
            ...
            Logger.getLogger("Minecraft").addHandler(consoleHandler);
            getLogger().info("Console output handler enabled");
        } catch (Exception e) {
            getLogger().warning("Failed to setup console output handler: " + e.getMessage());
        }
    }
    ...
    private void registerListeners() {
        ...
        if (getConfig().getBoolean("websocket.enabled", true)) {
            getServer().getPluginManager().registerEvents(
                new ConsoleListener(this, webSocketManager, serverId), 
                this
            );
        }
    }
