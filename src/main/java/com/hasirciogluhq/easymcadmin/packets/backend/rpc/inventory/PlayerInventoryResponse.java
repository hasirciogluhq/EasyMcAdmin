package com.hasirciogluhq.easymcadmin.packets.backend.rpc.inventory;
 ...
 */
public class PlayerInventoryResponse extends Packet {

    public PlayerInventoryResponse(String inventoryHash, String enderChestHash, boolean fullSync,
